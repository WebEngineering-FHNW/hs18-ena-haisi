...
<html>
    ...
    <body>
        <a href="#show-poster" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="show-poster" class="content scaffold-show" role="main">
